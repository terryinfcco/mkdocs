#  Codemy Tkinter Calculator YT Vid5-7
...
# Show results at top of screen
e = Entry(root, width=35, borderwidth=5)
# Put it at the top and have it span 3 columns
e.grid(row=0, column=0, columnspan=3, padx=10, pady=10)

def button_click(number):
    # First delete what's aleady in the box
